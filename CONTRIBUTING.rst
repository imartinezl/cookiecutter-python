...
Report bugs at https://github.com/audreyr/cookiecutter-python/issues
...
https://github.com/imartinez/cookiecutter-python/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-python` for local
...
2. Clone your fork locally:
   ...
   .. code-block:: bash
    ...
    $ git clone git@github.com:YOUR_NAME/cookiecutter-python.git
...
3. Assuming you have virtualenv installed (If you have Python3.5 this should
   ...
   .. code-block:: bash
        ...
        $ virtualenv cookiecutter-python-env
        $ source cookiecutter-python-env/bin/activate

   This should change the shell to look something like:

   .. code-block:: bash

        (cookiecutter-python-env) $
